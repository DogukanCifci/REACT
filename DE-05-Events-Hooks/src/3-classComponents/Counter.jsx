...
class Counter extends Component {
  constructor({ sayi }) {
    super({ sayi });
    this.state = { count: sayi || 0 }; //Bunun anlami da disardan gelen bir props var ise onu yazdir yoksa 0 yazdir
    // this.state = { count: 0 }; //state ismi sabit Componentten geliyor
    //this.state = {count : sayi} --> Eger App.jsden data olarak gönderdigim degeri kullanmak istersem props olarak aldigim degeri kulllanirim. Eger data almiycaksam disaardan constructor ici ve super ici bosbirakilir !!!!!
